    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="hidden md:flex flex-col w-64 bg-white border-r">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <SidebarLink href="/dashboard/tickets" icon="ticket" label="Tickets" />
          <SidebarLink href="/dashboard/knowledge-base" icon="knowledge" label="Knowledge Base" />
          <SidebarLink href="/dashboard/customers" icon="users" label="Customers" />
          <SidebarLink href="/dashboard/reports" icon="chart" label="Reports" />
          <SidebarLink href="/dashboard/settings" icon="settings" label="Settings" />
        </nav>
        <div className="p-4 border-t">
          <div className="flex items-center">
            <Avatar size="sm">
              <AvatarFallback initials="JS" />
            </Avatar>
            <div className="ml-3">
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <header className="bg-white border-b h-16 flex items-center px-4 md:px-6 justify-between">
          ...
          <div className="flex-1 md:flex-initial flex md:hidden items-center justify-center">
            <Link href="/dashboard" className="flex items-center">
              <svg className="w-7 h-7 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
              </svg>
              <span className="text-lg font-semibold">Support Desk</span>
            </Link>
          </div>
...
function SidebarLink({ href, icon, label }: SidebarLinkProps) {
  ...
  return (
    ...
    >
      <span className="text-gray-500 mr-3">{icons[icon]}</span>
      <span>{label}</span>
    </Link>
  )
} 